...
def init_args(server=True, ipykernel=False):
    ...
    parser.add_argument("--input_size", type=int, default=224, required=False, help="Input size. Default: 224")
    parser.add_argument("--output_size", type=int, default=224, required=False, help="Output size. Default: 224")
    ...
    parser.add_argument("--loss_fn", type=str, default="cross_entropy", required=False, help="Loss function. ex. cross_entropy, dice_loss, focal_loss. Default: cross_entropy")
